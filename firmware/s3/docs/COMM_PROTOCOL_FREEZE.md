# WatcheRobot S3 通讯协议冻结基线（0.1.5 / 2026-04-03）

## 0.1.5 总结
- 当前 `0.1.5` 版本继续采用 `Watcher-WS-Protocol v0.1.5` 作为板端对外网络协议基线。
...
- 当前版本的重点修复集中在动画系统显示对齐、动作系统 fallback 和启动阶段表达切换稳定性；这些改动没有改变本轮已冻结的对外消息方向。
